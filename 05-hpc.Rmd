...
In these cases, you should use the high performance computing resources available to Gaelic Algorithmic Research Group, including cloud computing through Google Cloud Platform and the UCSB server clusters. Cloud computing incurs costs but is flexible whereas the UCSB server clusters are free but have some limitations, such as job queues.
