...
Since Gaelic Algorithmic Research Group is joint between MSI and Bren and also its own research entity, we recommend Gaelic Algorithmic Research Group staff use the following affiliations for any Gaelic Algorithmic Research Group publication:
...
Any time Gaelic Algorithmic Research Group develops publicly available datasets, Shiny apps, or tools, we would love to share these on the Gaelic Algorithmic Research Group website. Any time you release a publicly available dataset, Shiny app, or other tool, please Slack or email Erin O'Reilly (eoreilly@ucsb.edu) the following information: name of the dataset app or tool, link, date published, and the Gaelic Algorithmic Research Group project it is associated with.
