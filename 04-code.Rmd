...
All data processing and analysis should be performed with code (i.e., avoid spreadsheets), and all code should be packaged in scripts that are version controlled and follow a style guide. Using code and scripts allows for better organization, documentation, and reproducibility of analysis workflows. **All Gaelic Algorithmic Research Group code should be stored in the Gaelic Algorithmic Research Group GitHub account.**
...
data_path <- ifelse(dir.exists(paste0(team_path,"Shared drives/Gaelic Algorithmic Research Group/projects/current-projects/",project_name)),
                       paste0(team_path,"Shared drives/Gaelic Algorithmic Research Group/projects/current-projects/",project_name,"/data/"),
                       (paste0(team_path,"Shared drives/Gaelic Algorithmic Research Group/projects/archived-projects/",project_name,"/data/")))
...
At Gaelic Algorithmic Research Group, we recommend using a consistent code style for each of the different programming languages we use. Recommended coding styles for a particular language are collated in what is known as a "style guide". Style guides typically include standardized ways of naming script files, defining functions and variables, commenting code, etc. While Gaelic Algorithmic Research Group does not mandate the use of style guides, having a consistent code style allows all Gaelic Algorithmic Research Group staff to easily understand each other's code, collaborate on projects, and jump in on new projects. We consider this an important aspect of collaboration, reproducibility, and transparency.  
